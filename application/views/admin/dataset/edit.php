<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Dataset Edit</h1>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form id="formDataset" class="form-horizontal">
                        <div class="card-body pt-3">
                            ...
                            <div class="form-group mt-3">
                                <label>Suhu</label>
                                <input type="number" class="form-control" id="suhu" value="<?= $data['suhu'] ?>" name="suhu" placeholder="Suhu ...">
                                <div class="invalid-feedback" id="suhu_error"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label>PH</label>
                                <input type="number" class="form-control" id="ph" value="<?= $data['ph'] ?>" name="ph" placeholder="PH ...">
                                <div class="invalid-feedback" id="ph_error"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label>TDS</label>
                                <input type="number" class="form-control" id="tds" value="<?= $data['tds'] ?>" name="tds" placeholder="TDS ...">
                                <div class="invalid-feedback" id="tds_error"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label>DO</label>
                                <input type="number" class="form-control" id="do" value="<?= $data['do'] ?>" name="do" placeholder="DO ...">
                                <div class="invalid-feedback" id="do_error"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label>Amonia</label>
                                <input type="number" class="form-control" id="amonia" value="<?= $data['amonia'] ?>" name="amonia" placeholder="Amonia ...">
                                <div class="invalid-feedback" id="amonia_error"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label>Nitrit</label>
                                <input type="number" class="form-control" id="nitrit" value="<?= $data['nitrit'] ?>" name="nitrit" placeholder="Nitrit ...">
